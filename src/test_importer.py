...
class TestNode(unittest.TestCase):
    ...
    def test_line_finder(self):
        read = read_in_file("./HeirView_test_export.ged")
        self.assertEqual(
            [(8, "2 VERS 5.5.1")], find_lines_by_tags(read, ["HEAD", "GEDC", "VERS"])
        )

    def test_file_blocks(self):
        read = read_in_file("./HeirView_test_export.ged")
        self.assertEqual(
            [(0, 14), (14, 32), (32, 50), (50, 68), (68, 86), (86, 96), (96, 96)],
            find_blocks(read),
        )
    ...
    def test_make_person_from_info(self):
        ...
        self.assertEqual(
            str(p), str(make_person_from_info(*collect_person_info(test_person_lines)))
        )
    ...
    def test_made_person_events(self):
        ...
        self.assertEqual(
            str(e),
            str(make_person_from_info(*collect_person_info(test_person_lines)).birth),
        )
    ...
    def test_event_missing(self):
        ...
        self.assertEqual(
            str(None), str(make_person_from_info(*collect_person_info(p)).death)
        )
