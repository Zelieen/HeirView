...
tt = Tree()
tt.add_person_by_name("Anakin", "Skywalker", 6)
tt.add_person_by_name("Padmé", "naberrie", 0)
tt.add_person_by_name("Luke", "Skywalker", 4)
tt.add_mother(4, 0)
tt.add_father(4, 6)
...
class TestNode(unittest.TestCase):
    ...
    def test_tree_add_person_by_name(self):
        t = Tree()
        t.add_person_by_name("Luke", "Skywalker")
        self.assertEqual("A family tree with 1 persons in it.", str(t))

    def test_tree_find(self):
        t = Tree()
        t.add_person_by_name("Luke", "Skywalker", 0)
        self.assertEqual("This is Person #0: Luke SKYWALKER.", str(t.find_person(0)))

    def test_tree_add_child(self):
        t = Tree()
        t.add_person_by_name("Anakin", "Skywalker", 0)
        t.add_person_by_name("Luke", "Skywalker", 1)
    ...
    def test_tree_add_partner(self):
        t = Tree()
        t.add_person_by_name("Anakin", "Skywalker", 0)
        t.add_person_by_name("Padmé", "naberrie", 1)
    ...
    def test_tree_get_free_IDs(self):
        t = Tree()
        t.add_person_by_name("Anakin", "Skywalker", 6)
        t.add_person_by_name("Padmé", "naberrie", 0)
        t.add_person_by_name("Luke", "Skywalker", 4)
        self.assertEqual([1, 2, 3, 5], t.get_all_free_IDs())

    def test_tree_get_next_free_ID(self):
        t = Tree()
        t.add_person_by_name("Anakin", "Skywalker", 3)
        t.add_person_by_name("Padmé", "naberrie", 0)
        self.assertEqual(1, t.get_next_free_ID())

    def test_tree_get_next_free_ID_add(self):
        t = Tree()
        t.add_person_by_name("Anakin", "Skywalker", 1)
        t.add_person_by_name("Padmé", "naberrie", 0)
    ...
    def test_tree_get_ancestors_for_chart(self):
        # use test Tree() tt
        t = tt
        t.add_person_by_name("Leia", "Skywalker", 8)
        t.add_person_by_name("Jacen", "Solo", 10)
        t.add_person_by_name("Han", "Solo", 9)
        t.add_father(8, 6)
        t.add_mother(8, 0)
